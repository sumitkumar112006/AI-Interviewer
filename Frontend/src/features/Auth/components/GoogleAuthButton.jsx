...
const GoogleIcon = () => (
    <svg className="google-icon-svg" viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
        <path
...
const GoogleAuthButton = ({ onError, text = "Continue with Google", disabled = false }) => {
    ...
    const handleGoogleAuth = async () => {
        if (!isSupabaseConfigured()) {
            const msg = "Supabase configuration is missing. Please check your environment variables.";
